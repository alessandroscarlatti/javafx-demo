 ...
 */
public class ProgressBarUi implements Widget {
    ...
    public static Container ui() {
        return new ProgressBarUi().getUi();
    }

    public ProgressBarUi(Runnable runnableWork) {
        throw new UnsupportedOperationException();
    }

    public static Container ui(Runnable runnableWork) {
        return new ProgressBarUi(runnableWork).getUi();
    }

    public ProgressBarUi(Callable<?> callableWork) {
        throw new UnsupportedOperationException();
    }

    public static Container ui(Callable<?> callableWork) {
        return new ProgressBarUi(callableWork).getUi();
    }

    public ProgressBarUi(Consumer<ProgressBarUi> config) {
        config.accept(this);
    }

    public static Container ui(Consumer<ProgressBarUi> config) {
        ...
        bus.connect().subscribe(eventsTopic, new TaskTemplateEventsNotifier() {
            ...
            public void started() {
                ...
                SwingUtilities.invokeLater(() -> {
                    paintTask = executor.submit(ProgressBarUi.this::paintProgressBar);  // start the paint task
                    configureByState();
                });
            }
